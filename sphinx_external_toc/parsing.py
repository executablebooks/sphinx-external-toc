...
def _parse_doc_item(
    ...
    *,
    ...
    :rtype: Tuple[Document, Sequence[Tuple[str, Dict[str, Any]]]]
    """
...
def _parse_docs_list(
    ...
    *,
    ...
    :type docs_list: Sequence[Tuple[str, Dict[str, Any]]]
...
def create_toc_dict(
    ...
    :type skip_defaults: bool, optional
...
def _docitem_to_dict(
    ...
    *,
    ...
    :param parsed_docnames: parsed document names cache used to prevent infinite
        recursion
    :type parsed_docnames: Optional[Set[str]], optional
    ...
    for toctree in doc_item.subtrees:
        ...
        toctree_data = {
            ...
            or getattr(toctree, key) != fields[key].default
        }
